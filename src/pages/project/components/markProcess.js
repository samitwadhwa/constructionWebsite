...
function ProjectModel({open, setOpen, id, pid}) {
  ...
  const navigate = useNavigate();
    // function for submiting the response of processed purchase Request!!!

  const handleSubmit = (e) => {
    console.log(value)
    
    
        axios.put(`${process.env.REACT_APP_BASE_URL}/api/projects/${id}/purchase-request/${pid}/process`,{} ,{headers: { authorization: `Bearer: ${token}` } }).then(res => {
    ...
    return (
      <div>
        ...
        >
           ...
           Do you want to mark this request as processed?
           </Box>
